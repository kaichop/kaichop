...
I am a scientific researcher at [CHOP](httpw://www.chop.edu) and [Penn](https://www.upenn.edu). My research focused on the development of bioinformatics tools to facilitate the implementation of genomic medicine. My lab webpage can be accessed [here](http://wglab.org), and my publication list can be accessed [here](https://scholar.google.com/citations?user=J_veo1sAAAAJ&hl=en). I got my PhD from **[UW](http://www.washington.edu)** and did my postdoc at [UPENN](https://www.upenn.edu) and [CHOP](https://www.chop.edu).
